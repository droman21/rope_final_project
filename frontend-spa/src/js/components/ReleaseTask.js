export default function ReleaseTask(releaseTask) {
    ...
    <ul class="releaseTask__info">
        ...
        <li class="releaseTask__currentStatusName">STATUS-NAME ${releaseTask.status.name}</li>
        <li class="releaseTask__currentPriorityId">PRIORITY-ID ${releaseTask.currentPriorityID}</li>
        <li class="releaseTask__currentPriorityName">PRIORITY-NAME ${releaseTask.priority.name}</li>
        ...
        <li class="releaseTask__assignedEmployeeId">ASSIGNED-TONAME: ${releaseTask.employee.name}</li>
    </ul>
